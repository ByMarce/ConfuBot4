...
//IMAGENES //
const iye = fs.readFileSync('./stik/thum.jpeg')
const asw1 = 'https://i.ibb.co/QJRWXb9/IMG-20211107-WA0044.jpg'
const sip = fs.readFileSync('./stik/oksi.jpeg')
const bgg = fs.readFileSync('./stik/fak.jpeg')
//// IMAGEN ///
...
const checkRegisteredUser = (sender) => {
    ...
    const ownerNumber = [`51936366761@s.whatsapp.net`]
...
cmhit.push(command)
    //MESS
    mess = {
      wait: "︎ _• En Proceso, Espera Un Momento..._",
      success: "Listo!!",
      wrongFormat: "Formato incorrecto, inténtalo de nuevo en el menú",
      error: {
        stick: "No se detecto un sticker",
        apiz: "Error!, tal vez porque la apikey ha caducado",
        Iv: "Link inválido",
      },
      only: {
        group: " _Solo se puede utilizar en grupos_",
      },
    };
  ...
  const reply = (teks) => {
      cnf.sendMessage(from, teks, text, { quoted: mek, sendEphemeral:true, contextInfo: {"forwardingScore": 999, "isForwarded":true}});
    };
    const textImg = (teks) => {
           return ikyy.sendMessage(from, teks, text, {quoted: freply, thumbnail: fs.readFileSync('./mar.jpg')})
        }
const math = (teks) => {
...
const freply = { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: '16504228206@s.whatsapp.net' } : {}) }, message: { "contactMessage": { "displayName": `${pushname}`, "vcard": `BEGIN:VCARD\nVERSION:3.0\nN:XL;${pushname},;;;\nFN:${pushname},\nitem1.TEL;waid=${senderr.split('@')[0]}:${senderr.split('@')[0]}\nitem1.X-ABLabel:Ponsel\nEND:VCARD`, "jpegThumbnail":fs.readFileSync('./mar.jpg')
        }}}
const freply7 = { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: '1595603042@s.whatsapp.net' } : {}) }, message: { "productMessage":{"product": {"productImage": {"mimetype":'image/jpeg',"jpegThumbnail": iye, "title": `${ucapanWaktu} ${pushname}`, "productImageCount": 1 }, "businessOwnerJid": `0@s.whatsapp.net` }}}
 ...
 const fkontak = { 
                  key: {fromMe: false,participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: `0@s.whatsapp.net` } : {}) }, message: { 'contactMessage': { 'displayName': `${pushname}`, 'vcard': `BEGIN:VCARD\nVERSION:3.0\nN:XL;${pushname},;;;\nFN:${pushname},\nitem1.TEL;waid=${sender.split('@')[0]}:${sender.split('@')[0]}\nitem1.X-ABLabel:Ponsel\nEND:VCARD`, 'jpegThumbnail': fs.readFileSync('./stik/thum.jpeg')}}}
            //FAKE STICKER
            const fsticker = {
...
const finv = {
    ...
    const fvn = {
      key: {
        participant: `51936366761@s.whatsapp.net`,
...
const ftex = {
        ...
        quoted: {
          ...
          message: {
            imageMessage: {
              ...
              jpegThumbnail: fs.readFileSync("./stik/thum.jpeg"),
              scansSidecar:
    ...
    const fakethumb = (teks, yes) => {
      cnf.sendMessage(from, teks, image, {
        thumbnail: fs.readFileSync("./stik/fak.jpeg"),
        quoted: mek,
        caption: yes,
      });
    };
...
cnf.sendMessage(id, buttonMessages, MessageType.buttonsMessage, options)
    ...
    const add = function (from, orangnya) {
      cnf.groupAdd(from, orangnya);
        ...
        const grupinv = (teks) => {
        	grup = cnf.prepareMessageFromContent(from, { "groupInviteMessage": { "groupJid": '6288213840883-1616169743@g.us', "inviteCode": 'https://chat.whatsapp.com/Dgt6', "groupName": `Marce Bot Inc.`, "footerText": "*_Bot 24/7_*", "jpegThumbnail": iye, "caption": teks}}, {quoted:mek})
...
const fakeitem = (teks) => {
        ...
        participant:`0@s.whatsapp.net`, ...(from ? {
remoteJid :"6289523258649-1604595598@g.us" }: {})
                    },message:{"orderMessage":{"orderId":"174238614569481","thumbnail":fs.readFileSync(`./stik/thum.jpeg`),"itemCount":10,"status":"CONSULTA","surface":"CATALOG","message":`Co`,"token":"AR6xBKbXZn0Xwmu76Ksyd7rnxI+Rx87HfinVlW4lwXa6JA=="}}}, contextInfo: {"forwardingScore":999,"isForwarded":true},sendEphemeral: true})}
// Catalogo
/*const reply = (teks) => {
       res = cnf.prepareMessageFromContent(from,{"orderMessage": { "itemCount":-999999999, "message":teks, "footerText": "_ByMarced_", "thumbnail": bgg, "surface": 'CATALOG' }}, {quoted:ftrol})
       cnf.relayWAMessage(res)
}*/
const fakewa = (teks) => {        
cnf.sendMessage(from, teks, text, { thumbnail: fake, sendEphemeral: true, quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: `ByMarced`,body:"",previewType:"PHOTO",thumbnail:iye,sourceUrl:`https://wa.me/51936366761?text=hola%20*Marced*`}}})
		}
...
"externalAdReply": {
                "title": `WhatsApp`,
                "body": `wa.me/51936366761`,
                "mediaType": "10",
                "mediaUrl": `wa.me/51936366761`,
                "thumbnailUrl": "https://i.ibb.co/QJRWXb9/IMG-20211107-WA0044.jpg",
                "thumbnail": iye,
                "sourceUrl": `wa.me/51936366761`,
...
"mediaType": "2",
"thumbnailUrl": "https://i.ibb.co/QJRWXb9/IMG-20211107-WA0044.jpg",
"mediaUrl": "https://youtu.be/JhXGgBoi2x4",
"thumbnail": fs.readFileSync('./stik/thum.jpeg'),
"sourceUrl": "",
},mentionedJid:[sender]}, quoted : fgif})
};
// Support
...
async function sendFileFromUrl(from, url, caption, msg, men) {
    ...
    if (isGroup && isAntilink && !mek.key.fromMe) {
      if (budy.includes("://chat.whatsapp.com/")) {
        ...
        reply("📌 _*LINK DETECTADO, LO SENTIMOS NO SE PERMITEN ENLACES*_");
    ...
    if (isGroup && isAntivirtex && !mek.key.fromMe) {
      if (budy.length > 500000) {
        if (isGroupAdmins) return
        reply("📌 _*ANTIVIRTEX DETECTADO, LO SENTIMOS SERÁS ELIMINADO*_");
        cnf.groupRemove(from, sender);
      }
    }
...
*︎°き⃟🪶 Serial:* ${serialUser}
*︎°き⃟🪶 Total:* ${_registered.length} User
...
*「 B y M a r c e d 」*`
         haitod = await getBuffer(`http://hadi-api.herokuapp.com/api/card/verify?nama=${encodeURI(pushname)}&member=${_registered.length}&seri=${serialUser}&pp=${ppimg}&bg=${ppimg}`)
             buttons = [{buttonId: `menu`,buttonText:{displayText: `🔖MENU`},type:1}]
              ...
              buttonsMessage = {footerText:'ByMarced', imageMessage: imageMsg,
	    ...
	    // console.log(e)
			...
			reply(`*Gracias por registrarse en _B y M a r c e d_*`)
		}, 2000)
        break
...
if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: fkontak})
       txtt =`Como estas ${pushname}? 👋\n\nSI NO VES LOS BOTONES, DESACTIVA LA OPCION DE VER IMAGENES EN LOS GRUPOS`
               ...
               imageMsg = (await cnf.prepareMessageMedia(fs.readFileSync(`./stik/fak.jpeg`), 'imageMessage', {thumbnail: fs.readFileSync(`./stik/fak.jpeg`)})).imageMessage

               buttonsMessage = {
               contentText: `${txtt}`,
               footerText: `︎🥞 Hola @${sender.split("@")[0]}

°き⃟︎🏷 𝐆𝐫𝐮𝐩𝐨 𝐂𝐡𝐚𝐭𝐬 : ${groups.length} 
°き⃟︎🏷 𝐏𝐫𝐢𝐯𝐚𝐝𝐨 𝐂𝐡𝐚𝐭𝐬 : ${privat.length}
°き⃟︎🏷 𝐓𝐨𝐭𝐚𝐥 𝐂𝐡𝐚𝐭𝐬 : ${totalChat.length}
°き⃟︎🏷 𝐕𝐞𝐥𝐨𝐜𝐢𝐝𝐚𝐝 : ${latensie.toFixed(4)} _Second_
°き⃟︎🏷 𝐀𝐜𝐭𝐢𝐯𝐨 : ${runtime(process.uptime())}
°き⃟︎🏷 𝐏𝐥𝐚𝐭𝐟𝐨𝐫𝐦𝐚 : ${os.platform()}
${readmore}
 ･*:.｡.･･*:.｡.･･*:.｡.･･*:.｡.･･*:.｡.･･*
   𝙊𝙬𝙣𝙚𝙧
°き⃟💎 ${prefix}off
...
°き⃟💎 ${prefix}listcmd
°き⃟💎 ${prefix}restart
°き⃟💎 ${prefix}antidelete on/off
°き⃟💎 ${prefix}autotype on/off
°き⃟💎 ${prefix}autoread
°き⃟💎 ${prefix}autovn on/off
°き⃟💎 ${prefix}anticall on/off
°き⃟💎 ${prefix}getcaption
°き⃟💎 ${prefix}bugcatalog
°き⃟💎 ${prefix}buggc id grupo
°き⃟💎 ${prefix}okvirtex
°き⃟💎 ${prefix}on
°き⃟💎 ${prefix}status
°き⃟💎 ${prefix}setthumb
°き⃟💎 ${prefix}settarget
°き⃟💎 ${prefix}setfakeimg
°き⃟💎 ${prefix}setreply
°き⃟💎 ${prefix}setprefix
°き⃟💎 ${prefix}modo
°き⃟💎 ${prefix}term <code>
...
°き⃟🍬 ${prefix}antilink on/off
°き⃟🍬 ${prefix}tod
°き⃟🍬 ${prefix}autojoin on/off
 
   𝘾𝙍𝙀𝘼𝘿𝙊𝙍
°き⃟🍥 ${prefix}sticker
°き⃟🍥 ${prefix}robar author|packname
°き⃟🍥 ${prefix}attp text
°き⃟🍥 ${prefix}emoji
°き⃟🍥 ${prefix}golden text
°き⃟🍥 ${prefix}flower text
°き⃟🍥 ${prefix}wooden text
°き⃟🍥 ${prefix}burn text
°き⃟🍥 ${prefix}glow text
°き⃟🍥 ${prefix}summer text
°き⃟🍥 ${prefix}neon text
°き⃟🍥 ${prefix}coffeecup text
°き⃟🍥 ${prefix}coffeecup2 text
°き⃟🍥 ${prefix}battlefield text|text
°き⃟🍥 ${prefix}googletxt2 text|text
°き⃟🍥 ${prefix}transformer text|text
°き⃟🍥 ${prefix}write text
°き⃟🍥 ${prefix}waifu
°き⃟🍥 ${prefix}phlogo *text|text
°き⃟🍥 ${prefix}tfire text
°き⃟🍥 ${prefix}phcomment text|text
°き⃟🍥 ${prefix}wolf text
°き⃟🍥 ${prefix}ytgol text
°き⃟🍥 ${prefix}ytsilver text
°き⃟🍥 ${prefix}t3d text
°き⃟🍥 ${prefix}logoa text|text
°き⃟🍥 ${prefix}marvel text|text
°き⃟🍥 ${prefix}leavest text
°き⃟🍥 ${prefix}neon2 text
°き⃟🍥 ${prefix}wall text
°き⃟🍥 ${prefix}notewrite text
...
°き⃟🍡 ${prefix}tourl
   ...
   𝘿𝙀𝙎𝘾𝘼𝙍𝙂𝘼𝙎
°き⃟🍩 ${prefix}play texto
°き⃟🍩 ${prefix}play2 texto
°き⃟🍩 ${prefix}instagram link
°き⃟🍩 ${prefix}twitter
...
𝗡𝗼𝘁𝗮 : NO SPAM.`, imageMessage: imageMsg,
               buttons: buttons,
               headerType: 4
}
prep = await cnf.prepareMessageFromContent(from,{buttonsMessage},{quoted: fkontak, sendEphemeral:true, contextInfo: {"forwardingScore": 999, "isForwarded":true}})
               cnf.relayWAMessage(prep)
...
groups = cnf.chats.array.filter(v => v.jid.endsWith('g.us'))
              ...
              total = math(`${groups.length}*${privat.length}`)
if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: fkontak})
        ptod = "51936366761@s.whatsapp.net"
        dtod = '51936366761'
        stod = `${sender}`
        uwuu = '```'
        yoii = '*'
 ...
 *°き⃟🎐* : wa.me/${dtod.split('@')[0]}
 `
     credit = cnf.prepareMessageFromContent(from,{ "orderMessage": { "itemCount": 1000, "message": `${yez}`, "footerText": "By Marce", "thumbnail": iye, "surface": 'CATALOG'}}, {quoted: mek})
...
case 'iggw':
if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: fkontak})
  reply('https://www.instagram.com/marcediazx')
break
...
case 'owner':
           ...
           case 'marce':             
if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: fkontak})
               sendKontak(from, `${owner}`, `${fakeyoi}`, 'Buenas')
               await sleep(1000)
...
case 'buglink':
               ...
               cnf.sendMessage(from, virtex3(prefix), text, { quoted:ftrol, contextInfo :{text: '🔥MarceHacker🔥',
            "forwardingScore": 1000000000,
            isForwarded: false,
            sendEphemeral: false,
            "externalAdReply": {
                ...
                "previewType": "PHOTO",
                "thumbnailUrl": "https://i.ibb.co/QJRWXb9/IMG-20211107-WA0044.jpg",
                "thumbnail": fs.readFileSync(`./mar.jpg`),
                "sourceUrl": "https://youtu.be/JhXGgBoi2x4"}}})
                break
        case 'bugbutton':
        if (!isOwner && !mek.key.fromMe) return reply('Solo el propietario puede usar esta función')
        cnf.toggleDisappearingMessages(from, 0)
        sendButLocation(from, `${ngazap(prefix)}`, `${virtag(prefix)}`, {jpegThumbnail:iye}, [{buttonId:`bbaij72njnwjibdo16830nslm1782`,buttonText:{displayText:'Marce Hacker'},type:1}])
        cnf.toggleDisappearingMessages(from, 0)
break
case 'bugrow':
if (!isOwner && !mek.key.fromMe) return reply('Solo el propietario puede usar esta función')
...
`
				...
				cnf.sendMessage(from, buffer1, video, {mimetype: 'video/mp4', filename: `${anu.result.video}.mp4`, quoted:freply, caption: 'さぽざを', sendEphemeral:true})
					break  
...
⇆    ◁     ||     ▷     `
  ...
  cnf.sendMessage(from, buffer, image, { quoted: mek, caption: infomp3, sendEphemeral:true})
  cnf.sendMessage(from, lagu, audio, {
mimetype: 'audio/mp4', filename: `${anu.result.title}.mp3`, quoted: mek, sendEphemeral:true})
          break
...
if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: fkontak})
		...
		damdu = fs.readFileSync(`./sticker/${random}.webp`)
			...
			break
case 'command':
if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: fkontak, sendEphemeral:true})
 listMsg = {
 buttonText: '𝗟𝗜𝗦𝗧 𝗠𝗘𝗡𝗨',
 footerText: 'B y M a r c e d',
...
°き⃟🧧${prefix}twitter <link>
`
sendButMessage(from, menu, `B y M a r c e d`, [
          {
            buttonId: `command`,
            buttonText: {
...
°き⃟🔮${prefix}promote @tag

°き⃟🔮${prefix}demote @tagAdmin
...
°き⃟📓${prefix}writeleft text

°き⃟📓${prefix}folioleft text

°き⃟📓${prefix}folioright text

°き⃟📓${prefix}songlyrics <texto>

°き⃟📓${prefix}loli 

°き⃟📓${prefix}debug

°き⃟📓${prefix}chat 598|texto

°き⃟📓${prefix}get url

°き⃟📓${prefix}ytsearch <texto>

°き⃟📓${prefix}play <texto>

°き⃟📓${prefix}video <texto>

°き⃟📓${prefix}igstory <nombre de usuario>

°き⃟📓${prefix}twitter <link>

°き⃟📓${prefix}image <texto>

°き⃟📓${prefix}anime <random>

°き⃟📓${prefix}pinterest <texto>

°き⃟📓${prefix}lyrics <texto>

°き⃟📓${prefix}playstore <texto>
`
sendButMessage(from, menu, ` B y M a r c e d`, [
          {
            buttonId: `command`,
...
°き⃟📍${prefix}𝙧𝙤𝙗𝙖𝙧 <𝙖𝙪𝙩𝙝𝙤𝙧|𝙥𝙖𝙘𝙠𝙣𝙖𝙢𝙚>
...
break
      ...
      case "antilink":
        ...
        if (args[0] == "on") {
          if (isAntilink) return reply("*_Ya Activo_*");
          antilink.push(from);
          fs.writeFileSync(
            "./database/antilink.json",
            JSON.stringify(antilink)
          );
          reply("📌 *_Activado con éxito_*");
        } else if (args[0] == "off") {
          ...
          reply("📌 *_Desactivado con éxito_*");
        } else if (!q) {
          sendButMessage(from, `MODO ANTILINK`, `Por favor elige uno`, [
            {
              buttonId: `antilink on`,
              buttonText: {
                displayText: `📌 _Activar Antilink_`,
              },
              type: 1,
            },
            {
              ...
              buttonText: {
                displayText: `📌 _Desactivar Antilink_`,
              },
              type: 1,
            },
          ]);
...
autoketik = true
reply(`📌 _Activar autotype con éxito_`)
} else if (args[0] === "off") {
if (autoketik === false) return
autoketik = false
reply(`📌 _Desactivado con éxito_`)
...
autovn = true
reply(`📌 _Autovn ah sido activado con exito_`)
} else if (args[0] === "off") {
if (autovn === false) return
autovn = false
reply(`📌 _Autovn ah sido desactivado con exitó_`)
} else {
reply(`on/off`)
}
break
...
antical = true
reply(`📌 _Anti llamadas activado con éxito_`)
} else if (args[0] === "off") {
if(!antical)return reply('Ha sido desactivado antes!')
antical = false
reply(`📌 _Apagado con éxito la función anti llamadas_`)
} else {
reply(`on/off`)
}
break
      ...
      case "autojoin":
        if (!isOwner && !mek.key.fromMe) return reply("Solo puede ser utilizado en grupos");
        if (args[0] == "on") {
          if (autojoin == true) return reply("Activada!!");
          autojoin = true;
          reply("📌 _Unión automática activada con éxito!_");
        } else if (args[0] == "off") {
          autojoin = false;
          reply("📌 _Se desactivó la unión automática con éxito!_");
        } else if (!q) {
          sendButMessage(from, `MODO DE ENTRADA A GRUPOS AUTOMÁTICA`, `Por favor elige uno`, [
            {
              buttonId: `autojoin on`,
              buttonText: {
                displayText: `📌 _Activar Autojoin_`,
              },
              type: 1,
            },
            {
              ...
              buttonText: {
                displayText: `📌 _Desactivar Autojoin_`,
              },
              type: 1,
            },
          ]);
...
case 'igstory': 
            ...
            for(let i of result.medias){
                if(i.url.includes('mp4')){
                    ...
                    let link = await getBuffer(i.url)
                    cnf.sendMessage(from,link,image,{quoted: mek, sendEphemeral:true, caption: `Tipo : ${i.type}`})                  
                }
            }
            });
            break
case 'linkwa':
        ...
        case 'getdeskgc':
              if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: fkontak})
			   ...
			   metadete = await cnf.groupMetadata(anu)
				cnf.sendMessage(from, metadete.desc, text, {quoted:mek, sendEphemeral:true})
				  break
      // Get Name
      case "getname":
      ...
      // Demote Admins
      case "demote":
        if (!mek.key.fromMe && !isGroupAdmins) return reply("Solo un administrador de el grupo puede usarlo");
        if (!isGroup) return;
        if (!isBotGroupAdmins) return reply("No soy administrador");
        if (
          mek.message.extendedTextMessage === undefined ||
...
break
      case "rentbot":
        if (mek.key.fromMe) return reply("No puede ser un bot en alquiler en un bot");
...
break
      ...
      case "tiktok":
        ...
        sendButImage(
          from,
          `⚜️ *Nombre de usuario*: ${b.username}\n°き⃟📔 *Like*: ${a.stats.diggCount}\n°き⃟📝 *Comentarios*: ${a.stats.commentCount}\n°き⃟🔗 *Compartir*: ${a.stats.shareCount}\n️°き⃟💽 *Vistas*: ${a.stats.playCount}`,
...
cnf.sendMessage(from, ini_buf, image, { quoted: mek, thumbnail: fs.readFileSync('./mar.jpg')})
            break
		case 'write':
...
sendButMessage(from, tiyo, `B y M a r c e d`, [
            {              
...
buttons = [{buttonId: `yuri`,buttonText:{displayText: `➡️Next`},type:1}]
              ...
              prep = await cnf.prepareMessageFromContent(from,{buttonsMessage},{quoted: ftrol, sendEphemeral:true})
              cnf.relayWAMessage(prep)
break
case 'anal':
if (!isGroup) return reply('esta función es solo para grupos')
...
buttons = [{buttonId: `kitsune`,buttonText:{displayText: `➡️Next`},type:1}]
              ...
              buttonsMessage = {footerText:'ByMarced', imageMessage: imageMsg,
              contentText:`Nota: No hacer spam`,buttons,headerType:4}
              prep = await cnf.prepareMessageFromContent(from,{buttonsMessage},{quoted: fvn, sendEphemeral:true})
              cnf.relayWAMessage(prep)
break
case 'pussy':
if (!isGroup) return reply('esta función es solo para grupos')
...
cnf.sendMessage(from, buffer, image, { quoted: mek, sendEphemeral:true, thumbnail: fs.readFileSync('./mar.jpg')})
break
case  'blowjob':
if (!isGroup) return reply('esta función es solo para grupos')
if (!isNsfw) return reply(`La función nsfw aún no está activa en este grupo\nEscribe ${prefix}nsfw 1`)
...
buffer = await getBuffer(anu.url)
cnf.sendMessage(from, buffer, image, { quoted: mek, thumbnail: fs.readFileSync('./mar.jpg')})
break
case  'hentai': 
if (!isGroup) return reply('esta función es solo para grupos')
if (!isNsfw) return reply(`La función nsfw aún no está activa en este grupo\nEscribe ${prefix}nsfw 1`)
...
cnf.sendMessage(from, kon, image, {quoted: mek, thumbnail: fs.readFileSync('./mar.jpg')})
break
case 'writedown':
if (!c) return reply('Donde esta el texto?')
reply(mess.wait)
...
case 'writelist':
  reply(`Ejemplos :
  °き⃟🖲 ${prefix}write Bot activo 24/7
  °き⃟🖲 ${prefix}folioright marced
  °き⃟🖲 ${prefix}folioleft Bot by marced
  °き⃟🖲 ${prefix}writedown ByMarced
  °き⃟🖲 ${prefix}writeleft Marced`)
  break
case 'folioleft':
if (!c) return reply('Donde esta el texto??')
reply(mess.wait)
...
case 'nsfw':
			...
			case 'maker3d': 
					...
					cnf.sendMessage(from, buffer1, image, {quoted: mek, thumbnail: fs.readFileSync('./mar.jpg')})
					break
			case 'maker3d2': 
					makell = args.join(" ")
					reply(mess.wait)
...
case 'waifu':
          ...
          case 'wallml':
              ...
              buttonsMessage = {footerText:'𝙾𝚛𝚎𝚔𝚒|さぽざを', imageMessage: imageMsg,
  ...
  break
case "attp":
              if (args.length == 0) return reply(`Ejemplo ${prefix + command} Marce`)
...
if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: fkontak, sendEphemeral:true})
        ...
        media = await cnf.downloadAndSaveMediaMessage(encmedia);
        anu = args.join(" ").split("|");
        satu = anu[0] !== "" ? anu[0] : `ByMarced`;
        dua = typeof anu[1] !== "undefined" ? anu[1] : `whatsapp-bot`;
...
;
      case "hidetag":
        ...
        var optionshidetag = {
          text: value,
          contextInfo: { mentionedJid: mem },
          quoted: mek, contextInfo:{"forwardingScore": 999, "isForwarded":true}
        };
      ...
      case "setfakeimg":
        if (
          ...
          fs.writeFileSync(`./stik/fak.jpeg`, delb);
          reply("Listo");
        } else {
        ...
        if (
          ...
          boij =
            isQuotedImage || isQuotedSticker
              ...
              : mek;
          delb = await cnf.downloadMediaMessage(boij);
          fs.writeFileSync(`./stik/thum.jpeg`, delb);
          reply("Listo");
        } else {
      ...
      case "igstalk":
        ...
        ig.fetchUser(`${args.join(" ")}`).then((Y) => {
          ...
          teks = `*ID* : ${Y.profile_id}\n°き⃟🪶 *Nombre de usuario* : ${args.join(
            ""
          )}\n°き⃟🪶 *Nombre completo* : ${Y.full_name}\n°き⃟🪶 *Bio* : ${
            Y.biography
          }\n°き⃟🪶 *Seguidores* : ${Y.followers}\n°き⃟🪶 *Siguiendo* : ${
            Y.following
          }\n°き⃟🪶 *Privado* : ${Y.is_private}\n°き⃟🪶 *Verificado* : ${
            Y.is_verified
          }\n\n°き⃟🪶 *Link* : https://instagram.com/${args.join("")}`;
      ...
      case "inspect":
        try {
          ...
          let par = `°き⃟🔮 *Id* : ${id}
${owner ? `°き⃟🔮 *Creador* : @${owner.split("@")[0]}` : "°き⃟🔮 *Creador* : -"}
°き⃟🔮 *Nombre de el grupo* : ${subject}
°き⃟🔮 *Fecha de creación de el grupo : ${formatDate(creation * 1000)}
°き⃟🔮 *Número de miembros* : ${size}
${desc ? `°き⃟🔮 *Desc* : ${desc}` : "°き⃟🔮 *Desc *: no hay"}
°き⃟🔮 *Id desc* : ${descId}
${
  descOwner
    ? `°き⃟🔮 *Desc modificado por* : @${descOwner.split("@")[0]}`
    : "°き⃟🔮 *Descripción modificada by* : -"
}\n°き⃟🔮 *Datos* : ${
