...
const gcrevoke = ["51936366761-1621430788@g.us"]
prefix = '/'
shp = '⬡'
owner = "51936366761@s.whatsapp.net"
spc1 = '         '
spc2 = '\n                           '
spc3 = '                   '
spc4 = '               '
...
const starts = async (client = new WAConnection()) => {
  ...
  client.browserDescription = ["ByMarced", "Chrome", "3.0"];
console.log(color(figlet.textSync('ByMarced', {
font: 'Standard',
...
console.log(color(`[ • CREADOR BYMARCED • ]` ,'cyan'))
...
whitespaceBreak: false
  ...
  client.on("qr", () => {
    console.log(
      ...
      client.sendMessage(`51936366761@s.whatsapp.net`, `「 *NOTIFICATION!* 」\n\n _Bot Connected Successfully!_`, MessageType.extendedText)
...
fkontakk = { key: {
  fromMe: false,
    participant: `0@s.whatsapp.net`, ...(anu.jid ? { remoteJid: '51936366761-1604595598@g.us' } : {})
},
 message: {
    "contactMessage":{"displayName":'Marce',"vcard":"BEGIN:VCARD\nVERSION:3.0\nN:2;ByMarced;;;\nFN:Creador\nitem1.TEL;waid=51936366761:+51 936 366 761\nitem1.X-ABLabel:Mobile\nEND:VCARD"
 }}}
...
${mdata.desc}`
                ...
                welcomeBut = [{buttonId:`verify`,buttonText:{displayText:'VERIFY'},type:1}]
      ...
      if (anu.action == "promote") {
        ...
        teks = `${anu_user} Ha sido promovido a Administrador 🎐`;
      ...
      if (anu.action == "demote") {
        ...
        teks = `${anu_user} Ha sido degradado a miembro común 🎐`;
        client.sendMessage(mdata.id, buffer, MessageType.image, {
          caption: teks,
        });
      }
